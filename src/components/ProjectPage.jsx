...
export default function ProjectPage({ project }) {
  ...
  useEffect(() => {
    ...
    const onMessage = (event) => {
      ...
      if (event.data?.type === 'route-ready') setReady(true);
  ...
  return (
    <main className={`original-project-shell ${ready ? 'is-ready' : ''}`}>
      <button
      ...
      <div className="original-project-loading" role="status">Loading</div>
      <iframe
        ref={iframeRef}
